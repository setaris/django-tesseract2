...
exec python manage.py run_gunicorn --bind=127.0.0.1:8000 --settings=settings.production --workers=$NUM_WORKERS --timeout=120 --graceful-timeout=120 1>>$LOGFILE 2>>$LOGFILE
